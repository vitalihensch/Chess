...
public class Queen extends ChessPiece{
    ...
    public Queen(PieceColor color,BufferedImage texture,int id,int x,int y,int width,int height) {
    ...
    if(((pieceY==mouseOnFieldY||pieceX==mouseOnFieldX)||(Math.abs(pieceX-mouseOnFieldX)==Math.abs(pieceY-mouseOnFieldY)))&&!isPieceInTheWay(mouseOnFieldX,mouseOnFieldY,fields))return true;
    else  return false;     
